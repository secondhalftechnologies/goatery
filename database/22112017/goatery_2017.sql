...
--
-- Host: localhost
-- Generation Time: Nov 21, 2017 at 07:45 PM
...
CREATE TABLE IF NOT EXISTS `tbl_goat_details` (
  ...
  `f7_breed_name` varchar(50) NOT NULL,
  ...
  `f7_water_source` varchar(50) NOT NULL,
  `status` int(11) DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `modified_date` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_goat_helth_and_medical` (
  ...
  `f8_vaccination_type` varchar(50) DEFAULT NULL,
